        ...
        h_flex()
            .child(
                ToggleButton::new("light", "Light")
                    ...
                    .on_click(|_, _window, cx| Self::write(ThemeMode::Light, cx))
                    .first(),
            )
            .child(
                ToggleButton::new("system", "System")
                    ...
                    .on_click(|_, _window, cx| Self::write(ThemeMode::System, cx))
                    .middle(),
            )
            .child(
                ToggleButton::new("dark", "Dark")
                    ...
                    .on_click(|_, _window, cx| Self::write(ThemeMode::Dark, cx))
                    .last(),
            )
    }
}
    ...
    fn render(self, window: &mut Window, cx: &mut AppContext) -> impl IntoElement {
        ...
        h_flex()
            ...
            .child(DropdownMenu::new(
                "ui-font-weight",
                value.0.to_string(),
                ContextMenu::build(window, cx, |mut menu, _cx| {
