...
use gpui::{
    AnyView, AppContext, Entity, EntityId, EventEmitter, ParentElement as _, Render, Styled, View,
    ViewContext, Window,
};
use ui::prelude::*;
...
trait ToolbarItemViewHandle: Send {
    ...
    fn focus_changed(&mut self, pane_focused: bool, _window: &mut Window, cx: &mut AppContext);
}
