use gpui::{div, prelude::*, px, AppContext, Render, SharedString, Styled, View, Window};
use ui::prelude::*;
use ui::Tooltip;
...
impl ScrollStory {
    pub fn view(window: &mut Window, cx: &mut AppContext) -> View<ScrollStory> {
        window.new_view(cx, |_cx| ScrollStory)
    }
}
