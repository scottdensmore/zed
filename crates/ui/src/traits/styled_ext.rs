...
fn elevated<E: Styled>(this: E, _window: &Window, cx: &AppContext, index: ElevationIndex) -> E {
...
pub trait StyledExt: Styled + Sized {
    ...
    fn border_primary(self, _window: &Window, cx: &AppContext) -> Self {
        self.border_color(cx.theme().colors().border)
    }

    /// The theme's secondary or muted border color.
    fn border_muted(self, _window: &Window, cx: &AppContext) -> Self {
