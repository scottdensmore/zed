...
impl TintColor {
    fn button_like_style(self, _window: &mut Window, cx: &mut AppContext) -> ButtonLikeStyles {
        match self {
    ...
    fn render(self, window: &mut Window, cx: &mut AppContext) -> impl IntoElement {
        ...
        self.base
            ...
            .map(|this| match self.size {
                ButtonSize::Large => this.px(DynamicSpacing::Base06.rems(window, cx)),
                ButtonSize::Default | ButtonSize::Compact => {
                    this.px(DynamicSpacing::Base04.rems(window, cx))
                }
