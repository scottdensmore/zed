...
impl NavigableEntry {
    ...
    pub fn new(scroll_handle: &ScrollHandle, _window: &Window, cx: &AppContext) -> Self {
        Self {
    ...
    pub fn focusable(_window: &Window, cx: &AppContext) -> Self {
        Self {
            focus_handle: cx.focus_handle(),
            scroll_anchor: None,
        }
...
impl RenderOnce for Navigable {
    fn render(self, _: &mut Window, _: &mut AppContext) -> impl crate::IntoElement {
        div()
            .on_action({
