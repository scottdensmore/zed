...
impl DividerColor {
    pub fn hsla(self, _window: &Window, cx: &AppContext) -> Hsla {
        match self {
...
impl Divider {
    ...
    pub fn render_solid(self, window: &Window, cx: &AppContext) -> impl IntoElement {
        div()
    ...
    pub fn render_dashed(self, window: &Window, cx: &AppContext) -> impl IntoElement {
