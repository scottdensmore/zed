    ...
    V: Render,
{
    ...
    let render_range = move |range, _window: &mut Window, cx: &mut AppContext| {
...
impl Element for UniformList {
    ...
    fn request_layout(
        ...
        let layout_id = self.interactivity.request_layout(
            ...
            |style, window, cx| match self.sizing_behavior {
                ListSizingBehavior::Infer => window.with_text_style(
                ...
                ListSizingBehavior::Auto => window.with_text_style(
                    style.text_style().cloned(),
    ...
    fn prepaint(
        ...
        let border = style.border_widths.to_pixels(window.rem_size(cx));
        let padding = style
            .padding
        ...
        self.interactivity.prepaint(
            ...
            |style, mut scroll_offset, hitbox, window, cx| {
                ...
                if self.item_count > 0 {
                    ...
                    window.with_content_mask(Some(content_mask), cx, |window, cx| {
