    ...
    fn scroll(
        ...
        if self.scroll_handler.is_some() {
            ...
            self.scroll_handler.as_mut().unwrap()(
                ...
                // REFACTOR ERROR Unexpected node type in call_expression_function_identifier: call_expression
                cx,
            );
        }
        ...
        window.transact(cx, |window, cx| {
            ...
            if bounds.size.height > padding.top + padding.bottom {
                ...
                for item in &mut layout_response.item_layouts {
                    ...
                    if let Some(autoscroll_bounds) = window.take_autoscroll(cx) {
                        if autoscroll {
...
impl Element for List {
    ...
    fn request_layout(
        ...
        let layout_id = match self.sizing_behavior {
            ...
            ListSizingBehavior::Auto => {
                ...
                window.with_text_style(
                    style.text_style().cloned(),
                    |window, cx| window.request_layout(style, None, cx),
                    cx,
                )
            }
        };
    ...
    fn prepaint(
        ...
        let padding = style
            .padding
            .to_pixels(bounds.size.into(), window.rem_size(cx));
    ...
    fn paint(
        ...
        window.on_mouse_event(cx, move |event: &ScrollWheelEvent, phase, window, cx| {
            if phase == DispatchPhase::Bubble && hitbox_id.is_hovered(window, cx) {
