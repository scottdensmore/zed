...
use crate::{
    ...
    AppContext, Asset, AssetSource, BackgroundExecutor, ClipboardItem, Context, DispatchPhase,
...
impl AppContext {
        ...
        self.update(|cx| {
            ...
            match Window::new(handle.into(), options, cx) {
                Ok(mut window) => {
                    ...
                    WindowContext::new(cx, &mut window)
                        .defer(|window, cx| window.appearance_changed(cx));
    ...
    pub fn observe_new_views<V: 'static>(
        ...
        self.new_view_observer(
            TypeId::of::<V>(),
            Box::new(
                move |any_view: AnyView, _window: &mut Window, cx: &mut AppContext| {
                    any_view
                        .downcast::<V>()
                        .unwrap()
